...
* [Create a GitHub issue](https://github.com/HMPO/hmpo-reqres/issues)
* [Open a Pull Request](https://github.com/HMPO/hmpo-reqres/pulls) to implement or fix a new or existing issue.
